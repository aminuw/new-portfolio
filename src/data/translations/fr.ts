export const fr = {
  ...
  nav: {
    ...
    projects: 'Projets',
    expertise: 'Expertise',
    journey: 'Parcours & Certifications',
    watch: 'Veille',
    contact: 'Contact',
    cv: 'CV',
  ...
  projects: {
    ...
    pageTitle: 'Mes',
    pageTitleItalic: 'Projets.',
    subtitle: "Une sélection de travaux alliant design épuré, performances techniques et expérience utilisateur fluide.",
  ...
  contact: {
    ...
    subjectLabel: 'Sujet',
    subjectPlaceholder: "Lancement d'une plateforme web",
    messageLabel: 'Message *',
    messagePlaceholder: 'Bonjour, je souhaite vous parler d\'un projet...',
    submit: 'Envoyer ma demande',
    submitting: 'Envoi en cours...',
    success: 'Message envoyé avec succès. Je vous réponds très vite !',
  ...
  competences: {
    ...
    title: 'technique.',
    subtitle: "Une maîtrise des technologies essentielle au service de la performance et du design.",
    ctaTitle: 'Découvrez la pratique',
    ctaText: "La théorie ne suffit pas. L'application de ces expertises se reflète dans mes expériences professionnelles et mes certifications certifiées.",
    ctaButton: 'Consulter mon parcours',
  },
  ...
  veille: {
    title: 'Veille',
    titleItalic: 'Tech.',
    subtitle: "Roadmap des innovations de l'écosystème",
    discover: 'Découvrir',
  },
  ...
  notFound: {
    ...
    title: 'Page',
    titleItalic: 'perdue.',
    description: "Il semblerait que vous vous soyez égaré. La page que vous cherchez n'existe plus ou a été déplacée.",
