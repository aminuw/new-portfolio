...
export default function MentionsLegales() {
  return (
    <div className="w-full relative selection:bg-zinc-950 selection:text-white pb-32">
      <section className="pt-48 px-4 md:px-12 max-w-4xl mx-auto">
        <Link href="/" className="font-mono text-sm text-zinc-500 hover:text-zinc-950 transition-colors uppercase tracking-widest mb-16 inline-block">
          ← Retour
        </Link>

        <h1 className="text-4xl md:text-6xl font-playfair font-bold text-zinc-950 tracking-tighter mb-16">
          Mentions <span className="italic font-light">Légales.</span>
        </h1>

        <div className="space-y-12 font-mono text-sm text-zinc-600 leading-relaxed">
          <div>
            <h2 className="text-lg font-bold text-zinc-950 mb-4 font-sans">1. Éditeur du site</h2>
            <p>
          ...
          <div>
            <h2 className="text-lg font-bold text-zinc-950 mb-4 font-sans">2. Hébergement</h2>
            <p>
          ...
          <div>
            <h2 className="text-lg font-bold text-zinc-950 mb-4 font-sans">3. Propriété intellectuelle</h2>
            <p>
