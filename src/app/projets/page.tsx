...
export default function Projects() {
  ...
  return (
    <div className="w-full pt-32 pb-16 px-4 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto md:px-12 flex flex-col border-t border-zinc-200 dark:border-zinc-800">
        <AnimatePresence mode="popLayout">
          {filteredProjects.map((project, index) => (
            <motion.a
              ...
              className="group flex flex-col md:flex-row py-12 border-b border-zinc-200 nacre-border hover:bg-white dark:hover:bg-zinc-900 transition-colors px-4 md:px-8 cursor-pointer gap-8 items-center"
            >
